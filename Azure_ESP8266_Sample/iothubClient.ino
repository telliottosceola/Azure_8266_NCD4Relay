...
static void sendMessage(IOTHUB_CLIENT_LL_HANDLE iotHubClientHandle, char *buffer, bool inputAlert)
{
    ...
    else
    {
        ...
        Map_Add(properties, "inputAlert", inputAlert ? "true" : "false");
